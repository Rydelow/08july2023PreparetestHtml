...
$PAGE->set_title('Test Section');
$PAGE->set_heading('Test Section');
$loginsite = 'Test Section';
//$PAGE->navbar->add($loginsite);

if(!empty($_GET['id'])){
$PAGE->navbar->add(($topbardata->title), new moodle_url('/blocks/searchdashboard/test_heading.php?id='.$id));
$PAGE->set_url('/blocks/searchdashboard/test_heading.php?id='.$id);
}
  ...
  ?>
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="he_ader ">
               <div class="edit1 ">
              <?php echo $topbardata->title; ?> Test Section
               </div>
...
$topbardataa = $DB->get_record('searchda_test_heading',array('thid'=>$id));
...
if ($mform->is_cancelled()) {
 ...
 $topbar_slider->title=$fromform->title;
  ...
  $DB->insert_record('searchda_test_heading', $topbar_slider,true);
redirect($CFG->wwwroot."/blocks/searchdashboard/exam_explore.php?sucessfully=inserted&id=".$fromform->thid);
  ...
  $DB->update_record('searchda_test_heading', $topbar_slider,true);
