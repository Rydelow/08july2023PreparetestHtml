...
// $attempts = quiz_get_user_attempts('255', $USER->id, 'all',true);
// echo "<pre>";
// print_r($attempts);
// print_r($attempts->state);
// echo "</pre>";
...
<section class="exp_exam">
    <div class="container">
      <div class="row">
          ...
          <div class="row">
<?php $testdata=$DB->get_records_sql("SELECT * from {searchda_complte_payment} where userid='".$USER->id."' ORDER by id DESC");
if(!empty($testdata)){
                              ...
                              <div class="quiz_details">
                                 <div class="quiz_name">
                                    <div style="flex: none; float: left;    ">
                                       ...
                                       <p id="quiz_heading_name" class="tim_e1"> <span class="cloc_k"> <i class="fas fa-clock"></i></span> <?= date("d-M-Y",$record->duedate); ?></p>
                                    </div>
                                 </div>
...
if(empty($atemdata)){
  echo '<p><span class="ng-binding"><b style="font-size: 23px;color: #212947;">Free</b></span></p>';
                              ...
                              <a class="start_test_btn ng-binding" href="<?php echo $CFG->wwwroot ?>/blocks/searchdashboard/instruction.php?id=<?= $record->id; ?>&base=<?php echo base64_encode($tvalue->base); ?>">
                              <div class="start_quiz">

                                 <?php
                                 if(empty($atemdata)){ ?>
 <p class="view_more_quez">Continue My Test</p>
                                 ...
                                 <p class="start_quiz_p">Start Test</p>

<?php }else{ ?>
  <a class="start_test_btn ng-binding" href="<?php echo $CFG->wwwroot ?>/blocks/searchdashboard/instruction.php?id=<?= $record->id; ?>&base=<?php echo base64_encode($tvalue->base); ?>">
<p class="start_quiz_p">Start Test</p></a>
<?php } } ?>
...
<section class="popular">
    <div class="container">
     <div class="row">
            ...
            <div class="col-md-12">
               <div class="cours_e">
        <?php $dataquery = $DB->get_records_sql("SELECT st.*,scs.slug as thirdslug,scs.title as seotitle,scs.keywords as seokeywords,scs.author as seoauther,scs.description,scs.status as seostatus FROM {searchda_third} as st left join {searchda_categories_seo} as scs on st.id=scs.th_id WHERE st.status='0' and st.popular_exams='1' ORDER BY st.sorting ASC");


        // $DB->get_records('searchda_third',array('status'=>0,'popular_exams'=>1));
        $i=1;
        ...
        <div class="row">
          <div class="col-md-6 col-12">
            <div class="prepare_test">
              <img src="https://preparetest.com/blocks/customhomepage/assets/cour_se_img.png" class="img-fluid" style="width: 72%;">
            </div>  
          </div>
          <div class="col-md-6 col-12">
