...
$topbardata = $DB->get_record('searchda_general_instruction',array('id'=>'1'));
//echo $topbardata->slider_content['text'];
// $mform->set_data($topbardata);

$setdata = new stdClass();
$setdata->id = '1';
$setdata->title=unserialize($topbardata->title);
...
$DB->update_record('searchda_general_instruction', $topbar_slider,true);
redirect($CFG->wwwroot."/blocks/searchdashboard/add_general_instruction.php?sucessfully=update");
