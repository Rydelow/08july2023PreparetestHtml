  ...
  ?>
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="he_ader ">
               <div class="edit1 ">
              <?php echo $topbardata->title; ?> More test Categories  Section
               </div>
...
$topbardataa = $DB->get_record('searchda_testcomeing',array('quizcategories'=>$quizcategories,'thid'=>$id));
...
$topbar_slider->createdtime=time();
  $DB->insert_record('searchda_testcomeing', $topbar_slider,true);
redirect($CFG->wwwroot."/blocks/searchdashboard/exam_explore.php?sucessfully=inserted&id=".$fromform->thid);
 ...
 $topbar_slider->quizcategories=$fromform->quizcategories;
  ...
  $DB->update_record('searchda_testcomeing', $topbar_slider,true);
