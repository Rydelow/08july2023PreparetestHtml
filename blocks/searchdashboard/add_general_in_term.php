...
$topbardata = $DB->get_record('searchda_in_term',array('id'=>'1'));
...
$DB->update_record('searchda_in_term', $topbar_slider,true);
redirect($CFG->wwwroot."/blocks/searchdashboard/add_instruction.php?sucessfully=update");
