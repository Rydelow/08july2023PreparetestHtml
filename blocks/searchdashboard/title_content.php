...
$PAGE->set_title('Test Content Section');
$PAGE->set_heading('Test Content Section');
  ...
  ?>
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="he_ader ">
               <div class="edit1 ">
              <?php echo $topbardata->title; ?> Testpaper Content Edit Section
               </div>
...
if ($mform->is_cancelled()) {
  ...
  $topbar_slider->t_content=serialize($fromform->t_content);
