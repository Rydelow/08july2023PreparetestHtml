...
$PAGE->set_title('All Comments');
$PAGE->set_heading('All Comments');
$loginsite = 'All Comments';
//$PAGE->navbar->add($loginsite);
$PAGE->navbar->add(('All Comments'), new moodle_url('/blocks/customhomepage/commentupdate.php'));
$PAGE->set_url('/blocks/customhomepage/commentupdate.php');
echo $OUTPUT->header();
    ...
    <table id="example" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th scope="col">All Comment Update</th>
            </tr>
        </thead>
...
<tr>
  ...
  <td><a href='<?php echo $CFG->wwwroot . '/blocks/customhomepage/allcommentupdate.php?id='.$coursedata->id;?>'>All Comments </td>
  </tr>
<?php } ?>
