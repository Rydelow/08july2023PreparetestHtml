...
include('form_general_instruction.php');
...
$topbardataa = $DB->get_record('searchda_general',array('postid'=>$data->postid,'tableid'=>$id));
...
$DB->insert_record('searchda_general', $topbar_slider,true);
...
$topbar_slider->positive_marks=$fromform->positive_marks;
  ...
  $DB->update_record('searchda_general', $topbar_slider,true);
