...
$PAGE->set_title('Header Section');
$PAGE->set_heading('Header Section');
$loginsite = 'Header Section';
//$PAGE->navbar->add($loginsite);

if(!empty($_GET['id'])){
$PAGE->navbar->add(($topbardata->title), new moodle_url('/blocks/searchdashboard/header_edit.php?id='.$id));
$PAGE->set_url('/blocks/searchdashboard/header_edit.php?id='.$id);
}
  ...
  ?>
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="he_ader ">
               <div class="edit1 ">
              <?php echo $topbardata->title; ?> Header Section
               </div>
...
$topbardataa = $DB->get_record('searchda_header',array('thid'=>$id));
//echo $topbardata->slider_content['text'];
// $mform->set_data($topbardata);
$setdata = new stdClass();
$setdata->thid = $id;
$setdata->id = $topbardataa->id;
$setdata->titleone=$topbardataa->titleone;
$setdata->titletwo=$topbardataa->titletwo;
$setdata->titlethree=$topbardataa->titlethree;
$setdata->digitone=$topbardataa->digitone;
$setdata->digittwo=$topbardataa->digittwo;
$setdata->digitthree=$topbardataa->digitthree;
...
if ($mform->is_cancelled()) {
 ...
 $topbar_slider->titleone=$fromform->titleone;
$topbar_slider->titletwo=$fromform->titletwo;
$topbar_slider->titlethree=$fromform->titlethree;
$topbar_slider->digitone=$fromform->digitone;
$topbar_slider->digittwo=$fromform->digittwo;
$topbar_slider->digitthree=$fromform->digitthree;
  $topbar_slider->createdtime=time();
  $DB->insert_record('searchda_header', $topbar_slider,true);
...
$topbar_slider->digitthree=$fromform->digitthree;
  ...
  $DB->update_record('searchda_header', $topbar_slider,true);
