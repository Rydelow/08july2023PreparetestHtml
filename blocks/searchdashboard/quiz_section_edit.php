...
$PAGE->set_title('Testpaper Categories Section');
$PAGE->set_heading('Testpaper Categories Section');
  ...
  ?>
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="he_ader ">
               <div class="edit1 ">
              <?php echo $topbardata->title; ?> Testpaper Categories  Section
               </div>
...
$topbardataa = $DB->get_record('searchda_quiz_section_ca',array('id'=>$cid));
...
$setdata->freetext=$topbardataa->freetext;
$setdata->testpaper=$topbardataa->testpaper;
...
if ($mform->is_cancelled()) {
 ...
 $topbar_slider->quizcategories=$fromform->quizcategories;
$topbar_slider->freetext=$fromform->freetext;
$topbar_slider->testpaper=$fromform->testpaper;
$topbar_slider->createdtime=time();
  $DB->insert_record('searchda_quiz_section_ca', $topbar_slider,true);
...
$topbar_slider->testpaper=$fromform->testpaper;
  ...
  $DB->update_record('searchda_quiz_section_ca', $topbar_slider,true);
