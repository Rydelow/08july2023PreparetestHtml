...
<div class="bundle_table">
	<div class="table_heading"> Running Batch Table </div>
	<table id="usetTable" border="1">
		...
		<tr>
			<td><?=$batchrow->id?></td>
			<td><a href="studentdetails.php?bundle_id=<?=$batchrow->id?>" target="_blank"><?=$batchrow->total_student?></a></td>
