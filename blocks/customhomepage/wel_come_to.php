...
$PAGE->set_title('Home Page Welcome To content');
$PAGE->set_heading('Home Page Welcome To content');
$loginsite = 'Custom Home Page';
//$PAGE->navbar->add($loginsite);
$PAGE->navbar->add(('Home Page Welcome To content'), new moodle_url('/blocks/customhomepage/wel_come_to.php'));
$PAGE->set_url('/blocks/customhomepage/wel_come_to.php');
echo $OUTPUT->header();
...
redirect($CFG->wwwroot."/blocks/customhomepage/wel_come_to.php?sucessfully=update");
