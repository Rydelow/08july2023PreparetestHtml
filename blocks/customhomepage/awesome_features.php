...
$PAGE->set_title('Home Page All Awesome Features Content');
$PAGE->set_heading('Home Page All Awesome Features Content');
$loginsite = 'Custom Home Page';
//$PAGE->navbar->add($loginsite);
$PAGE->navbar->add(('Home Page All Awesome Features Content'), new moodle_url('/blocks/customhomepage/awesome_features.php'));
...
<?php $notification = $DB->get_records('customhmp_awesome_features'); 
$i=1;
...
?>
          ...
          <tr>
            <td><?php echo  $i++; ?></td>
            <td><?php echo $value->awesome_features; ?></td>
           <td> 
                    <ul class="ul_drop">
               
<li><a href="<?= $CFG->wwwroot; ?>/blocks/customhomepage/insert_awesome_features.php?id=<?php echo $value->id; ?>" class="btn-info infon">  <i class="fa fa-pencil" aria-hidden="true"></i> </a></li>
