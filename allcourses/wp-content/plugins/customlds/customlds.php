...
function bbloomer_save_new_checkout_field( $order_id ) { 
    if ( $_POST['billing_first_name'] ) update_post_meta( $order_id, 'billing_first_name', esc_attr( $_POST['billing_first_name'] ) );
    if ( $_POST['billing_last_name'] ) update_post_meta( $order_id, 'billing_last_name', esc_attr( $_POST['billing_last_name'] ) );
    if ( $_POST['billing_email'] ) update_post_meta( $order_id, 'billing_email', esc_attr( $_POST['billing_email'] ) );
