...
.potentialidp:last-child {
    background-color: #4267b2 !important;
}

.potentialidp:first-child {
    background-color: red !important;
}
.potentialidp a.btn.btn-secondary.btn-block{    background: transparent;
}
.potentialidp:first-child a:hover {
    background: #cc3636!important;
}
.potentialidp:last-child a:hover {
    background: #375fb1!important;
}
