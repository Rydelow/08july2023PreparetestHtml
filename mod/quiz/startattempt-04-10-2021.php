...
if (!$cm = get_coursemodule_from_id('quiz', $id)) {
	echo "get_coursemodule_from_id";
	echo "<br/>";
    print_error('invalidcoursemodule');
}
if (!$course = $DB->get_record('course', array('id' => $cm->course))) {
	echo "get course record";
	echo "<br/>";
...
if (!$quizobj->has_questions()) {
    ...
    if ($quizobj->has_capability('mod/quiz:manage')) {
		...
		//echo "if not quizobj has no questions";
...
if($currentattemptid){
    if ($lastattempt->state == quiz_attempt::OVERDUE) {
		...
		echo "-----summary_url--------";
		echo "<br/>";
		echo $quizobj->summary_url($lastattempt->id);
		echo "<br/>";
    } else {
        redirect($quizobj->attempt_url($currentattemptid, $page));
		echo "-----attempt url current attempt id------";
		echo "<br/>";
		echo $quizobj->attempt_url($currentattemptid, $page);
		echo "<br/>";
    }
}
...
echo "----attempt url----";
echo "<br/>";
//echo $quizobj->attempt_url($attempt->id, $page);
echo "<br/>";
